...
Current working implementation is available within Discord within the [Bot channel](https://discord.gg/TcqupVuz) as the `API Alex Testing` bot.
...
We will be working on <Link to="/docs/activities/PhotoSky/intro">PhotoSky</Link> and review some fundamentals of CS development with <Link to="/docs/category/basics">Git</Link>!
